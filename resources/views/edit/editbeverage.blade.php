...
@section('content')
<h1>Edit Beverage</h1>
{!! Form::open(['action' => ['c2@updateBeverage', $post->id], 'method' => 'POST']) !!}
        ...
        <div class="form-group">
            {{Form::label('caterogy', 'Category')}}
            {{Form::text('caterogy', $post->category, ['class' => 'form-control', 'placeholder' => 'Write the price of the food item.'])}}
        </div>
