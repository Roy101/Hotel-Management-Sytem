...
@section('content')
<h1>Add Beverage Items</h1>
{!! Form::open(['action' => 'c2@storeBeverage', 'method' => 'POST']) !!}
        ...
        <div class="form-group">
            ...
            {{Form::text('category', '', ['class' => 'form-control', 'placeholder' => 'Write the category of the food item.'])}}
        </div>
